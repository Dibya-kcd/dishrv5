...
class BillPreviewModal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final items = provider.currentBill!['items'] as List<CartItem>;
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              Container(
                ...
                child: Column(children: [
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Text('${provider.currentBill!['date']}', style: const TextStyle(color: Colors.black)),
                  ]),
                  Align(alignment: Alignment.centerLeft, child: Text('Table: ${provider.currentBill!['table']}', style: const TextStyle(color: Colors.black))),
                ]),
              ),
              ...
              Column(children: [
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text('₹${(provider.currentBill!['subtotal'] as double).toStringAsFixed(2)}', style: const TextStyle(color: Colors.black)),
                ]),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  const Text('GST (5%):', style: TextStyle(color: Colors.black)),
                  Text('₹${(provider.currentBill!['gst'] as double).toStringAsFixed(2)}', style: const TextStyle(color: Colors.black)),
                ]),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  const Text('TOTAL:', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
                  Text('₹${(provider.currentBill!['total'] as double).toStringAsFixed(2)}', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
                ]),
              ]),
              const SizedBox(height: 8),
              Container(
                ...
                alignment: Alignment.center,
                child: Text('Payment: ${provider.currentBill!['paymentMethod']}', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.black)),
              ),
              const SizedBox(height: 12),
              Row(children: [
                Expanded(
